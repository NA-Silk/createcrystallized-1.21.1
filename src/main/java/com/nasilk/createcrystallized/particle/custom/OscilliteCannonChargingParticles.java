...
public class OscilliteCannonChargingParticles extends SimpleAnimatedParticle {
    private final double xi, yi, zi;
    private final double xf, yf, zf;

    protected OscilliteCannonChargingParticles(
        ClientLevel level,
        SpriteSet spriteSet,
        double x, double y, double z,
        double xSpeed, double ySpeed, double zSpeed
    ) {
        super(level, x + xSpeed, y + ySpeed, z + zSpeed, spriteSet, 0.0f); // Start on the outside and stall, tick() handles the movement
    ...
    public void tick() {
        ...
        float vScale = 0.5f * progress * progress; // Scale with progress^2
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(
            ...
            return new OscilliteCannonChargingParticles(
                clientLevel,
                this.spriteSet,
                x, y, z,
